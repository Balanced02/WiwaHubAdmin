...
exports.GetProducts = exports.CreateProduct = exports.ChangePremium = undefined;
...
var GetProducts = exports.GetProducts = function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime2.default.mark(function _callee(req, res) {
    var page, _ref2, _ref3, count, products, username;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.prev = 2;
            _context.next = 5;
            return Promise.all([_Products2.default.find().count(), _Products2.default.find().sort('name').skip(page * 25 - 25).limit(25)]);
